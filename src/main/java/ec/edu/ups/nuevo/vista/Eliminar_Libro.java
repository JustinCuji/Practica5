 ...
 * @author davidvargas
 */
public class Eliminar_Libro extends javax.swing.JInternalFrame {

    private LibroControlador libroControlador;

    /**
     * Creates new form Eliminar_Libro
     */
    public Eliminar_Libro(LibroControlador libroControlador) {
        initComponents();
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (!titulo.isEmpty()) {
            Libro libroEliminar = libroControlador.buscar(titulo);

            if (libroEliminar != null) {
                // Pregunta al usuario para confirmar la eliminación
                int opcion = JOptionPane.showConfirmDialog(this, "¿Está seguro de eliminar el libro?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);

                if (opcion == JOptionPane.YES_OPTION) {
                    // Intenta eliminar el libro y verifica el resultado
                    boolean eliminado = libroControlador.eliminarLibro(libroEliminar);
            ...
            // Si el campo de título está vacío, muestra un mensaje de advertencia
            JOptionPane.showMessageDialog(this, "Ingrese el título del libro a eliminar", "Advertencia", JOptionPane.WARNING_MESSAGE);
        }
