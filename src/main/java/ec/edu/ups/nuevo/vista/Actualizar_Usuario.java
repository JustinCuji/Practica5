...
public class Actualizar_Usuario extends javax.swing.JInternalFrame {
     ...
     */
    public Actualizar_Usuario(UsuarioControlador usuarioControlador) {
        initComponents();
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (controladorUsuario.actualizar(usuario)){
            JOptionPane.showMessageDialog(this, "El Usuario ha sido actualizada exitosamente! :)");
            this.limpiarCampos();
        }else{
            JOptionPane.showMessageDialog(this, "El Usuario no ha sido actualizada! :(");
        }
